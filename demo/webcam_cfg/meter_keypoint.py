...
executor_cfg = dict(
    ...
    nodes=[
        ...
        dict(
            ...
            det_model_checkpoint='/home/ahmed/work/mmdetection/checkpoints/yolox_tiny_8x8_300e_coco_20211124_171234-b4047906.pth',
            pose_model_config='/home/ahmed/work/mmpose/configs/meter/hrnetv2_w18_meter_256x256.py',
            pose_model_checkpoint='/home/ahmed/work/mmpose/work_dirs/hrnet_w32_meter_256x192/latest.pth',
            det_interval=10,
            class_ids=[75],
            #labels=['person'],
            smooth=True,
