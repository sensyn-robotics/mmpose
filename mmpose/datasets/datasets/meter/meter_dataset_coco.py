...
class MeterDatasetCoco(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('/home/ahmed/work/mmpose/configs/_base_/datasets/meter.py')
